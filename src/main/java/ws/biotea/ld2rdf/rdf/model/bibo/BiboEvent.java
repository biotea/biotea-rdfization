 ...
 */
public class BiboEvent extends Thing {

    /** http://purl.org/ontology/bibo/Event */
    @SuppressWarnings("hiding")
	public static final URI RDFS_CLASS = new URIImpl("http://purl.org/ontology/bibo/Event", false);

    /** http://purl.org/ontology/bibo/presents */
    @SuppressWarnings("hiding")
	public static final URI PRESENTEDAT = new URIImpl("http://purl.org/ontology/bibo/presents",false);
    ...
    public static final URI[] MANAGED_URIS = {
      new URIImpl("http://purl.org/ontology/bibo/presents",false) 
    };
	 ...
	 */
	protected BiboEvent ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public BiboEvent ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public BiboEvent ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public BiboEvent ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 */
	public BiboEvent ( Model model, boolean write ) {
	 ...
	 * @return an instance of BiboEvent  or null if none existst
	 *
	 * [Generated from RDFReactor template rule #class0] 
	 */
	public static BiboEvent  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, BiboEvent.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://purl.org/ontology/bibo/Event).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends BiboEvent> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, BiboEvent.class );
	}

    /**
	 * Remove rdf:type BiboEvent from this instance. Other triples are not affected.
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'Presentedat' to this BiboEvent instance
	 *
	...
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllbiboPresentedat_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Document.PRESENTEDAT, objectValue);
	}
	...
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllbiboPresentedat_Inverse() {
		return Base.getAll_Inverse(this.model, Document.PRESENTEDAT, this.getResource() );
	}

	/**
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as a ReactorResult, that have a relation 'Presentedat' to this BiboEvent instance
	 *
	...
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllbiboPresentedat_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Document.PRESENTEDAT, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}



    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@19a6a1e has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@19a6a1e has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     ...
     */
	public static ClosableIterator<Document> getAllbiboPresentedat(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll(model, instanceResource, PRESENTEDAT, Document.class);
	}
     ...
     */
	public static ReactorResult<Document> getAllbiboPresentedat_as(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll_as(model, instanceResource, PRESENTEDAT, Document.class);
	}
     ...
     */
	public ClosableIterator<Document> getAllbiboPresentedat() {
		return Base.getAll(this.model, this.getResource(), PRESENTEDAT, Document.class);
	}
     ...
     */
	public ReactorResult<Document> getAllbiboPresentedat_as() {
		return Base.getAll_as(this.model, this.getResource(), PRESENTEDAT, Document.class);
	}
    ...
    /**
     * Adds a value to property Presentedat from an instance of Document 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 *
	 * [Generated from RDFReactor template rule #add3static] 
     */
	public static void addbiboPresentedat(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Document value) {
		Base.add(model, instanceResource, PRESENTEDAT, value);
	}
     ...
     */
	public void addbiboPresentedat(Document value) {
		Base.add(this.model, this.getResource(), PRESENTEDAT, value);
	}
    ...
    /**
     * Sets a value of property Presentedat from an instance of Document 
     * First, all existing values are removed, then this value is added.
     * Cardinality constraints are not checked, but this method exists only for properties with
     * no minCardinality or minCardinality == 1.
     * @param model an RDF2Go model
     ...
     */
	public static void setbiboPresentedat(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Document value) {
		Base.set(model, instanceResource, PRESENTEDAT, value);
	}
     ...
     */
	public void setbiboPresentedat(Document value) {
		Base.set(this.model, this.getResource(), PRESENTEDAT, value);
	}
     ...
     */
	public static void removebiboPresentedat(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Document value) {
		Base.remove(model, instanceResource, PRESENTEDAT, value);
	}
