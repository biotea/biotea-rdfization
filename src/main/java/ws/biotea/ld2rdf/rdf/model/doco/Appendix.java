 ...
 */
public class Appendix extends A_0 {
	private static final long serialVersionUID = 1L;

	/** http://purl.org/spar/doco/Appendix */
	public static final URI RDFS_CLASS = new URIImpl("http://purl.org/spar/doco/Appendix", false);
	 ...
	 */
	protected Appendix ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Appendix ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Appendix ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public Appendix ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 */
	public Appendix ( Model model, boolean write ) {
	 ...
	 * @return an instance of Appendix  or null if none existst
	 *
	 * [Generated from RDFReactor template rule #class0] 
	 */
	public static Appendix  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, Appendix.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://purl.org/spar/doco/Appendix).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends Appendix> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, Appendix.class );
	}

    /**
	 * Remove rdf:type Appendix from this instance. Other triples are not affected.
	...
	public void addSection(Model model, Section section, String parameter) {
		if (parameter != null) {
