 ...
 */
public class List extends DiscourseElement {

    /** http://purl.org/spar/doco/List */
    @SuppressWarnings("hiding")
	public static final URI RDFS_CLASS = new URIImpl("http://purl.org/spar/doco/List", false);
	 ...
	 */
	public static List  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, List.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://purl.org/spar/doco/List).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends List> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, List.class );
	}

    /**
	 * Remove rdf:type List from this instance. Other triples are not affected.
