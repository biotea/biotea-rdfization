...
public class Document extends Thing {
	private JournalE journal;
	private OrganizationE publisher;
	 ...
	 * [Generated from RDFReactor template rule #add4dynamic] 
     */
	private String biboPageEnd;
	public void addbiboPageend(java.lang.String value) {
		Base.add(this.model, this.getResource(), PAGEEND, value);
		this.biboPageEnd = value;
	}
	
	public String getBiboPageEnd() {
		return this.biboPageEnd;
	}
	 ...
	 * [Generated from RDFReactor template rule #add4dynamic] 
     */
	private String biboPageStart;
	public void addbiboPagestart(java.lang.String value) {
		Base.add(this.model, this.getResource(), PAGESTART, value);
		this.biboPageStart = value;
	}
	
	public String getBiboPageStart() {
		return this.biboPageStart;
	}
	 ...
	 * [Generated from RDFReactor template rule #add4dynamic] 
     */
	private String biboVolume;
	public void addbiboVolume(java.lang.String value) {
		Base.add(this.model, this.getResource(), VOLUME, value);
		this.biboVolume = value;
	}
	
	public String getBiboVolume() {
		return this.biboVolume;
	}
	/**
     * Adds a value to property Volume from an instance of java.lang.String 
	 *
	...
	public static final URI DCTERMS_VERSION = new URIImpl(DCTERMS_NS + "hasVersion", false);
	...
	public static final URI SIO_IN_DATASET = new URIImpl(OntologyPrefix.SIO.getURL() + "SIO_001278", false);
	...
	public void addSection(Model model, ws.biotea.ld2rdf.rdf.model.doco.Section section, String parameter) {
		if (parameter != null) {
			...
			listOfSections.addMember(model, section, ++this.listOfSectionsIndex);
		}		
	...
	public void addDCVersion(Model model, String version){
		PlainLiteral descAsLiteral = model.createPlainLiteral(version);	    
	    Statement stm = model.createStatement(this.asResource(), DCTERMS_VERSION, descAsLiteral);
	    model.addStatement(stm); //version
	}
	...
	public void addInDataset(Model model, String uriString) {
		Node uriNode = model.createURI(uriString);
		Statement stm = model.createStatement(this.asResource(), SIO_IN_DATASET, uriNode);
	...
	public void addJournalAsIt(JournalE journal) {
		this.journal = journal;
	}
	
	public JournalE getOneJournal() {		
		return this.journal;
	}
	
	public void addPublisherAsIt(OrganizationE publisher) {
		this.publisher = publisher;
	}
	
	public OrganizationE getOnePublisher() {
