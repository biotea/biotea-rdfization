...
import ws.biotea.ld2rdf.rdf.model.bibo.BookSection;

public class BookSectionE extends BookSection{
	...
	public BookSectionE(Model model, String uriString, boolean write)
	...
	public void addShortTitle(Model model, String title) {
		Node titleNode = new PlainLiteralImpl(title);
	    this.addbiboShorttitle(titleNode);
	}
