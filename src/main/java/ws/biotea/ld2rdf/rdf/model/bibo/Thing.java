...
public class Thing extends org.ontoware.rdfreactor.schema.rdfs.Class {
	...
	public void setListOfSections(ListOfElements listOfSections) {
		this.listOfSections = listOfSections;
	}
	public ListOfElements getListOfSections() {
		return this.listOfSections;
	}
	
	private ListOfElements listOfParagraphs;
	public void setListOfParagraphs(ListOfElements listOfParagraphs) {
		this.listOfParagraphs = listOfParagraphs;
	}
	public ListOfElements getListOfParagraphs() {
		return this.listOfParagraphs;
	}
 }