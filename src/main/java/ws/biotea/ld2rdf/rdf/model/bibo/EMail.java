 ...
 */
public class EMail extends PersonalCommunicationDocument {

    /** http://purl.org/ontology/bibo/Email */
    @SuppressWarnings("hiding")
	public static final URI RDFS_CLASS = new URIImpl("http://purl.org/ontology/bibo/Email", false);
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://purl.org/ontology/bibo/Email).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
