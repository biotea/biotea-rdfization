...
public class Container extends Thing {
	...
	public static final URI RDFS_CLASS = new URIImpl("http://www.essepuntato.it/2008/12/pattern#Container", false);
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.essepuntato.it/2008/12/pattern#Container).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
