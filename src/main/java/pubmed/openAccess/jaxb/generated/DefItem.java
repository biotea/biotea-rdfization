...
public class DefItem {
    ...
    protected List<Object> devesAndXS;
    @XmlAttribute
    ...
    /**
     * Gets the value of the devesAndXS property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the devesAndXS property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDevesAndXS().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getDevesAndXS() {
        if (devesAndXS == null) {
            devesAndXS = new ArrayList<Object>();
        }
        return this.devesAndXS;
    }
